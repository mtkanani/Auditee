    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-extrabold text-slate-100 tracking-tight">{title || 'AUDITEE'}</h2>
          <p className="text-xs text-slate-400 mt-1">{subtitle || 'Enterprise CA Firm SaaS Platform'}</p>
        </div>
